...
%%
figure
plot(t,smoothdata(infoG,1,"movmean",[3,3]),'Color',[0.7 0 0.5],'LineWidth',5)
hold on
plot(t,smoothdata(infoM,1,"movmean",[3,3]),'Color',[1 0.4 0],'LineWidth',5)

plot([0 0],[0 1],'--k','LineWidth',3)
axis([-1 12 0 1])
box off
set(gca,'FontSize',15,'YTick',[0:0.5:1],'XTick',[0 4 8 12])
