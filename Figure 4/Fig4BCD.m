...
[N2,vx2,vy2,drug_range2]=resistances2(M);
...
hold on
idx = find(drug_range>drug(1),1);
% Plot line
p3 = plot(10.^drug_range(idx:end),vx2(1,idx:end),'Color',col(3,:),'LineWidth',6);
p1 = plot(10.^drug_range(idx:end),vx2(2,idx:end),'Color',col(1,:),'LineWidth',6);
p2 = plot(10.^drug_range(idx:end),vx2(3,idx:end),'Color',col(2,:),'LineWidth',6);
...
% Avg scatter
s3 = scatter(10.^drug,avg(:,1,1),200,col(3,:),'filled','MarkerEdgeColor','black','LineWidth',3);
s1 = scatter(10.^drug,avg(:,2,1),200,col(1,:),'filled','MarkerEdgeColor','black','LineWidth',3);
s2 = scatter(10.^drug,avg(:,3,1),200,col(2,:),'filled','MarkerEdgeColor','black','LineWidth',3);
...
hold on
% Plot line
p3 = plot(10.^drug_range(idx:end),vy2(1,idx:end),'Color',col(3,:),'LineWidth',6);
p1 = plot(10.^drug_range(idx:end),vy2(2,idx:end),'Color',col(1,:),'LineWidth',6);
p2 = plot(10.^drug_range(idx:end),vy2(3,idx:end),'Color',col(2,:),'LineWidth',6);
...
% Avg scatter
s3 = scatter(10.^drug,avg(:,1,2),200,col(3,:),'filled','MarkerEdgeColor','black','LineWidth',3);
s1 = scatter(10.^drug,avg(:,2,2),200,col(1,:),'filled','MarkerEdgeColor','black','LineWidth',3);
s2 = scatter(10.^drug,avg(:,3,2),200,col(2,:),'filled','MarkerEdgeColor','black','LineWidth',3);
