...
% Mann-Whitney U-test
[p,h] = ranksum(dat(dat(:,2)==1),dat(dat(:,2)==2));

% STYLISHLY add stats to current plot using ritzStar
newY = ritzStar([1,2],p,4.5);
