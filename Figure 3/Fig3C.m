...
fname ='data.xlsx';
dat_wt = readtable(fname,'Sheet','WT1000');
cfu_wt = readtable(fname,'Sheet','CFU1000_WT');
...
dat_z = readtable(fname,'Sheet','KOmexZ1000');
cfu_z = readtable(fname,'Sheet','CFU1000_KOmexZ');
...
dat_y = readtable(fname,'Sheet','KOmexY1000');
cfu_y = readtable(fname,'Sheet','CFU1000_KOmexY');
